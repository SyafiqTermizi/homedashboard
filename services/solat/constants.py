...
class Location(enum.StrEnum):
    ...
    KTN01 = (
        "KTN01",
        "Bachok, Kota Bharu, Machang, Pasir Mas, Pasir Puteh, Tanah Merah, Tumpat, Kuala Kr",
    )
    KTN02 = (
        "KTN02",
    ...
    PRK05 = (
        "PRK05",
        "Kg Gajah, Teluk Intan, Bagan Datuk, Seri Iskandar, Beruas, Parit, Lumut, Sitiaw",
    )
    PRK06 = ("PRK06", "Selama, Taiping, Bagan Serai, Parit Buntar")
    PRK07 = ("PRK07", "Bukit Larut")
    SBH01 = (
        "SBH01",
        "Bahagian Sandakan (Timur), Bukit Garam, Semawang, Temanggong, Tambisan, Banda",
    )
    SBH02 = (
        "SBH02",
    ...
    SBH07 = (
        "SBH07",
        "Kota Kinabalu, Ranau, Kota Belud, Tuaran, Penampang, Papar, Putatan, Bahagian Panta",
    )
    SBH08 = (
        "SBH08",
    ...
    SWK06 = (
        "SWK06",
        "Lubok Antu, Sri Aman, Roban, Debak, Kabong, Lingga, Engkelili, Betong, Spaoh, Pusa",
    )
